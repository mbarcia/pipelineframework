...
/**
 * Plugin interface for reactive unary processing operations.
 * This interface is used for plugins that process a single input and perform a side-effect operation.
 *
...
public interface PluginReactiveUnary<T> extends BasePlugin {
    /**
     * Process the input object asynchronously and return a Uni representing completion.
     *
