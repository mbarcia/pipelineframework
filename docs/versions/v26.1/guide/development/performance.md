...
Parallelism is configured at the pipeline level. See the [Configuration Reference](/versions/v26.1/guide/build/configuration/) for the exact settings.
...
[Expansion and Reduction](/versions/v26.1/guide/design/expansion-and-reduction).
