...
- [Canvas Designer Guide](/versions/v26.1/guide/getting-started/canvas-guide) - Complete guide to using the visual designer
- [Application Structure](/versions/v26.1/guide/design/application-structure) - Learn how the generated application is structured
- [Functional Architecture](/versions/v26.1/guide/evolve/architecture) - Deep dive into the framework architecture
...
See [Template Generator Guide](/versions/v26.1/guide/evolve/template-generator) for details.
