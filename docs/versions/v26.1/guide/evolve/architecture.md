...
- [Annotation Processor Architecture](/versions/v26.1/guide/evolve/annotation-processor-architecture): Deep dive into the build-time IR, bindings, and renderers
