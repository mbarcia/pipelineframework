...
Parallelism is configured at the pipeline level. See the [Configuration Reference](/versions/v26.2/guide/build/configuration/) for the exact settings.
...
[Expansion and Reduction](/versions/v26.2/guide/design/expansion-and-reduction).

## Server Execution Strategy

Service-side execution (event loop vs. blocking or virtual threads) affects throughput for I/O-heavy steps. See [@PipelineStep Annotation](/versions/v26.2/guide/development/pipeline-step) for service-side execution options.
